...
var logic_deporte = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _id, nombre, query;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _id = (request === null || request === void 0 ? void 0 : request.body)._id;
                nombre = (request === null || request === void 0 ? void 0 : request.body).nombre;
                return [4 /*yield*/, deporte_1["default"].findByIdAndUpdate(_id, {
                        nombre: nombre
                    })];
            case 1:
                query = _a.sent();
                if (!query)
                    return [2 /*return*/, response.status(404).json("not found")];
...
var logic_equipo = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var nombre, _id, query;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                nombre = (request === null || request === void 0 ? void 0 : request.body).nombre;
                _id = (request === null || request === void 0 ? void 0 : request.body)._id;
                return [4 /*yield*/, equipo_1["default"].findByIdAndUpdate(_id, {
                        nombre: nombre
                    })];
            case 1:
                query = _a.sent();
...
var logic_evento = function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, nombre, fecha, marcador, equipo1, equipo2, tipo_deporte, _id, query;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = request === null || request === void 0 ? void 0 : request.body, nombre = _a.nombre, fecha = _a.fecha, marcador = _a.marcador, equipo1 = _a.equipo1, equipo2 = _a.equipo2, tipo_deporte = _a.tipo_deporte, _id = _a._id;
                return [4 /*yield*/, evento_1["default"].findByIdAndUpdate(_id, {
                        nombre: nombre,
                        fecha: fecha,
                        marcador: marcador,
                        equipo1: equipo1,
...
//# sourceMappingURL=editit.js.map